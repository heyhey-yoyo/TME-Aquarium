...
export const MECHANISMS = [
  ...
  },
  {
    ...
    translation:'巨噬细胞依据邻近碎片、癌细胞和局部低氧梯度选择运动目标；炎症调节功能轴而不直接提供趋化方向。持续低氧使功能轴偏向抑制/修复，并产生有限的血管支持场。',
  ...
  },
  {
    ...
    translation:'巨噬细胞清除凋亡碎片时增加 efferocytosisMemory、修复/抑制活性及局部抑制场，不即时降低急性炎症；清除坏死碎片时短时增加局部急性炎症并向炎症支持方向移动，不增加该记忆。移除坏死碎片减少其后续持续炎症来源。',
    caveat:'模型不区分全部死亡方式、吞噬受体与下游代谢，仅区分凋亡与坏死清除的即时状态变化及移除持续刺激源的后续效应。', refs:['SOKI2014','WERFEL2019']
  },
  {
